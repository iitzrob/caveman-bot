...
> **Open this if you want to sponsor a giveaway.**`,
  ...
  // Category a service ticket (build/dig/mapart/regears) gets moved to as
  // soon as a staff member claims it — moved back to whichever service
  // category it came from as soon as it's unclaimed. Leave '' to disable
  // (claiming will still work, the channel just won't relocate).
  claimedServiceCategoryId: '1534029689306480651',
